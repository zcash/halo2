...
/// ```
/// use halo2_core::poly::Rotation;
/// # use halo2_core::pasta::Fp;
/// # use halo2_core::plonk::ConstraintSystem;
///
...
/// row when required:
/// ```
/// use halo2_core::{arithmetic::FieldExt, circuit::{Chip, Layouter}, plonk::{Advice, Column, Error, Selector}};
/// # use ff::Field;
/// # use halo2_core::plonk::Fixed;
///
/// struct Config {
///     a: Column<Advice>,
///     b: Column<Advice>,
