...
pub(crate) struct X<F: PrimeField>(pub AssignedCell<Assigned<F>, F>);
...
impl<F: PrimeField> std::ops::Deref for X<F> {
...
pub(crate) struct Y<F: PrimeField>(pub Value<Assigned<F>>);
...
impl<F: PrimeField> std::ops::Deref for Y<F> {
