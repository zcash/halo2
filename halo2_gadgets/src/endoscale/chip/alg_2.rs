...
impl<F: PrimeFieldBits, const K: usize> Bitstring<F, K> {
    #[cfg(test)]
...
pub(crate) struct TableConfig<F: WithSmallOrderMulGroup<3>, const K: usize> {
    pub(crate) bits: TableColumn,
    pub(crate) endoscalar: TableColumn,
    _marker: PhantomData<F>,
}

impl<F: WithSmallOrderMulGroup<3>, const K: usize> TableConfig<F, K> {
    #[allow(dead_code)]
