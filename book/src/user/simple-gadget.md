# Building a simple gadget

This example walks through how to build a custom [gadget](../concepts/gadgets.md) and
[chip](../concepts/chips.md) from scratch. We define a trait of numeric instructions,
implement them as a chip, and wire them into a circuit.

If you want to see how to build a circuit using an *existing* gadget instead, see
[Building a simple circuit](simple-circuit.md).

The circuit will take a public input $c$, and will prove knowledge of two private
...
```rust,ignore,no_run
{{#include ../../../halo2_proofs/examples/simple-gadget.rs:instructions}}
```
...
```rust,ignore,no_run
{{#include ../../../halo2_proofs/examples/simple-gadget.rs:chip}}
```
...
```rust,ignore,no_run
{{#include ../../../halo2_proofs/examples/simple-gadget.rs:chip-impl}}
```
...
```rust,ignore,no_run
{{#include ../../../halo2_proofs/examples/simple-gadget.rs:chip-config}}
```

## Implement chip traits

```rust,ignore,no_run
{{#include ../../../halo2_proofs/examples/simple-gadget.rs:instructions-impl}}
```
...
```rust,ignore,no_run
{{#include ../../../halo2_proofs/examples/simple-gadget.rs:circuit}}
```
...
```rust,ignore,no_run
{{#include ../../../halo2_proofs/examples/simple-gadget.rs:test-circuit}}
```

## Full example

You can find the source code for this example
[here](https://github.com/zcash/halo2/tree/main/halo2_proofs/examples/simple-gadget.rs).
