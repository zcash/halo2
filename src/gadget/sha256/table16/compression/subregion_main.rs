...
impl Compression {
    pub fn assign_round<F: FieldExt>(
        ...
        if idx < 63 {
            ...
            self.assign_and_constrain(region, a_7, a_new_row, &a_new_dense.0.into(), &self.perm)?;
            ...
            self.assign_and_constrain(region, a_7, e_new_row, &e_new_dense.0.into(), &self.perm)?;
            self.assign_and_constrain(
                region,
                a_7,
                e_new_row + 1,
